...
<head>
    ...
    <title>{{ $site_title }} | {{ $page_title ?? 'Dashboard' }}</title>
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
            ...
            <header class="logo-env">
                ...
                <div class="logo">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset($site_logo ?? 'assets/images/logo.png') }}" width="120" alt="Logo" />
                    </a>
                </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('admin/settings') }}">
                                <i class="fa fa-cog"></i> <span>Site Logo Setting</span>
                            </a>
                        </li>
                        <!--<li>
    ...
    <!-- Footer -->
        <footer class="main">
            ...
            &copy; Copyright @php echo date('Y'); @endphp <strong><a href="https://www.wizinoa.com/" target='_blank'></a>All  Reserved.</strong>
