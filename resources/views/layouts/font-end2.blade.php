...
<title>{{ $site_title ?? 'My Laravel Site' }}</title>


    <!-- Favicon -->
   <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/images') }}/{{ $general->favicon ?? 'default-favicon.png' }}">
                ...
                <div class="col-lg-8 col-md-9 col-sm-12 col-xs-12 pull-right address_container">
                    <div>
                        ...
                        <div class="text_holder">
                            @if(isset($general))
                            <p>Phone Call <span>{{ $general->number }}</span></p>@endif
                        </div>
                    </div>
                    <div>
                        <div class="icon_holder">
                        ...
                        <div class="text_holder">
                            @if(isset($general))
                            <p>Mail Us <span>{{ $general->email }}</span></p>@endif
                        </div>
                    </div>
                    <div>
                        <div class="icon_holder">
